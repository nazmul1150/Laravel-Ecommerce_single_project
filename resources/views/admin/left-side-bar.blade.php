		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li>
						<a href="{{route('admin.dashbord')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Home</span>
						</a>
					</li>

					<li>
						<a href="{{route('admin.homecategories')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Home Categories</span>
						</a>
					</li>
					<li>
						<a href="{{route('admin.sale')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Sale Time</span>
						</a>
					</li>
					<li>
						<a href="{{route('admin.coupon')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Coupon</span>
						</a>
					</li>

					<li>
						<a href="{{route('admin.homeslider')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Home Slider</span>
						</a>
					</li>
					...
					<li>
						<a href="{{route('admin.subcategory')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Sub Category</span>
						</a>
					</li>
