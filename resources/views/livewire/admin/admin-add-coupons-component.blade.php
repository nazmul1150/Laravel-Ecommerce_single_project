        ...
        <div class="min-height-200px">
            ...
            <!-- horizontal Basic Forms Start -->
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="" method="POST" wire:submit.prevent="storeCoupon">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" placeholder="Coupon Value" wire:model='value' />
                            @error('value') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group">
                            <label>Coupon Cart Value</label>
                            <input class="form-control" type="number" placeholder="Coupon Cart Value" wire:model='cart_value' />
