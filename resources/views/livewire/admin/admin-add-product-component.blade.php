        ...
        <div class="min-height-200px">
            ...
            <!-- horizontal Basic Forms Start -->
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" wire:submit.prevent="addProduct" >
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @error('sort_description') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <input class="btn btn-primary btn-bg" type="submit" value="Add Product">
                        </div>
                    </form>
