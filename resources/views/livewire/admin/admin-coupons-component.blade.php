                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        ...
                        <div class="pull-right">
                            <a href="{{route('admin.addcoupon')}}" class="btn btn-primary btn-sm">Add Coupon</a>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.editcoupon', ['coupon_id'=>$coupon->id])}}" class="btn btn-primary">Edit</a>
                                    <a href="#" onclick="confirm('Are you sure, You want to delete this Coupon?') || event.stopImmediatePropagation()" class="btn btn-danger" wire:click.prevent="deleteCoupon({{$coupon->id}})">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
